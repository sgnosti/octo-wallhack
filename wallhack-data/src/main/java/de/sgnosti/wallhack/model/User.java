...
public class User {
	...
	public boolean equals(Object other) {
		...
		return new EqualsBuilder().append(rateLimitStatus, rhs.rateLimitStatus).append(accessLevel, rhs.accessLevel)
				.append(id, rhs.id).append(name, rhs.name).append(email, rhs.email).append(screenName, rhs.screenName)
				.append(location, rhs.location).append(description, rhs.description)
				.append(descriptionURLEntities, rhs.descriptionURLEntities).append(url, rhs.url)
				.append(followersCount, rhs.followersCount).append(status, rhs.status)
				.append(profileBackgroundColor, rhs.profileBackgroundColor)
				.append(profileTextColor, rhs.profileTextColor).append(profileLinkColor, rhs.profileLinkColor)
				.append(profileSidebarFillColor, rhs.profileSidebarFillColor)
				.append(profileSidebarBorderColor, rhs.profileSidebarBorderColor)
				.append(profileUseBackgroundImage, rhs.profileUseBackgroundImage)
				.append(showAllInlineMedia, rhs.showAllInlineMedia).append(friendsCount, rhs.friendsCount)
				.append(createdAt, rhs.createdAt).append(favouritesCount, rhs.favouritesCount)
				.append(utcOffset, rhs.utcOffset).append(timeZone, rhs.timeZone)
				.append(profileBackgroundImageUrlHttps, rhs.profileBackgroundImageUrlHttps)
				.append(profileBackgroundTiled, rhs.profileBackgroundTiled).append(lang, rhs.lang)
				.append(statusesCount, rhs.statusesCount).append(translator, rhs.translator)
				.append(listedCount, rhs.listedCount).append(withheldInCountries, rhs.withheldInCountries)
				.append(_protected, rhs._protected).append(contributorsEnabled, rhs.contributorsEnabled)
				.append(profileImageURL, rhs.profileImageURL).append(biggerProfileImageURL, rhs.biggerProfileImageURL)
				.append(miniProfileImageURL, rhs.miniProfileImageURL)
				.append(originalProfileImageURL, rhs.originalProfileImageURL)
				.append(profileImageURLHttps, rhs.profileImageURLHttps)
				.append(biggerProfileImageURLHttps, rhs.biggerProfileImageURLHttps)
				.append(miniProfileImageURLHttps, rhs.miniProfileImageURLHttps)
				.append(originalProfileImageURLHttps, rhs.originalProfileImageURLHttps)
				.append(defaultProfileImage, rhs.defaultProfileImage).append(defaultProfile, rhs.defaultProfile)
				.append(profileBackgroundImageURL, rhs.profileBackgroundImageURL)
				.append(profileBannerURL, rhs.profileBannerURL)
				.append(profileBannerRetinaURL, rhs.profileBannerRetinaURL)
				.append(profileBannerIPadURL, rhs.profileBannerIPadURL)
				.append(profileBannerIPadRetinaURL, rhs.profileBannerIPadRetinaURL)
				.append(profileBannerMobileURL, rhs.profileBannerMobileURL)
				.append(profileBannerMobileRetinaURL, rhs.profileBannerMobileRetinaURL)
				.append(geoEnabled, rhs.geoEnabled).append(verified, rhs.verified)
				.append(followRequestSent, rhs.followRequestSent).append(urlentity, rhs.urlentity)
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(rateLimitStatus).append(accessLevel).append(id).append(name).append(email)
				.append(screenName).append(location).append(description).append(descriptionURLEntities).append(url)
				.append(followersCount).append(status).append(profileBackgroundColor).append(profileTextColor)
				.append(profileLinkColor).append(profileSidebarFillColor).append(profileSidebarBorderColor)
				.append(profileUseBackgroundImage).append(showAllInlineMedia).append(friendsCount).append(createdAt)
				.append(favouritesCount).append(utcOffset).append(timeZone).append(profileBackgroundImageUrlHttps)
				.append(profileBackgroundTiled).append(lang).append(statusesCount).append(translator)
				.append(listedCount).append(withheldInCountries).append(_protected).append(contributorsEnabled)
				.append(profileImageURL).append(biggerProfileImageURL).append(miniProfileImageURL)
				.append(originalProfileImageURL).append(profileImageURLHttps).append(biggerProfileImageURLHttps)
				.append(miniProfileImageURLHttps).append(originalProfileImageURLHttps).append(defaultProfileImage)
				.append(defaultProfile).append(profileBackgroundImageURL).append(profileBannerURL)
				.append(profileBannerRetinaURL).append(profileBannerIPadURL).append(profileBannerIPadRetinaURL)
				.append(profileBannerMobileURL).append(profileBannerMobileRetinaURL).append(geoEnabled).append(verified)
				.append(followRequestSent).append(urlentity).append(additionalProperties).toHashCode();
	}
